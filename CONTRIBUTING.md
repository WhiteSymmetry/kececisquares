...
* The kececisquares version you are using.
...
Ready to contribute? Here's how to set up kececisquares for local development.
...
2. Create your own fork of the kececisquares [repository](https://github.com/WhiteSymmetry/kececisquares).
